...
export class SentimentService {
  ...
  private readonly positiveWords = [
    'excelente', 'increíble', 'perfecto', 'genial', 'fantástico',
    'maravilloso', 'bueno', 'lindo', 'bonito', 'recomiendo',
    'delicioso', 'rica', 'rico', 'fresco', 'limpio', 'amable',
    'profesional', 'rápido', 'eficiente', 'cómodo', 'agradable',
    'espectacular', 'impecable', 'top', '10/10', 'amazing',
  ];

  private readonly negativeWords = [
    'malo', 'terrible', 'pésimo', 'horrible', 'feo',
    'sucio', 'lento', 'caro', 'desagradable', 'no recomiendo',
    'decepcionante', 'decepcionado', 'decepcionada', 'error',
    'problema', 'queja', 'lamentable', 'deficiente', 'regular',
    'nunca más', 'evitar', 'peor', 'asco', 'asco',
  ];
