...
describe("EmpresaService", () => {
  ...
  describe("getOwnerPlace", () => {
    ...
    it("should throw NotFoundException if no place", async () => {
      ...
      await expect(service.getOwnerPlace("invalid-user")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("getOwnerReviews", () => {
    it("should return reviews for owner place", async () => {
      ...
      const result = await service.getOwnerReviews("user-1", {
        skip: 0,
        limit: 20,
      });
  ...
  describe("getOwnerStats", () => {
    ...
    it("should throw NotFoundException if no place", async () => {
      ...
      await expect(service.getOwnerStats("invalid-user")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("getOwnerDashboard", () => {
    ...
    it("should throw NotFoundException if no place", async () => {
      ...
      await expect(service.getOwnerDashboard("invalid-user")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
