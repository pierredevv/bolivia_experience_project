      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
          ...
          <div>
            ...
            >
              <span className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-emerald-600 text-white text-xs sm:text-sm font-semibold flex items-center justify-center" aria-hidden="true">2</span>
              <span className="text-xs sm:text-sm font-medium border border-neutral-200 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 text-slate-500">{t('feat.badge')}</span>
            </motion.div>
            ...
            <div className="space-y-4">
              {features.map((key, i) => (
                ...
                >
                  <div className="h-6 w-6 rounded-full bg-emerald-600 flex items-center justify-center shrink-0 mt-0.5">
          ...
          >
            <div className="w-[280px] h-[560px] rounded-[3rem] bg-slate-900 border-[3px] border-slate-800 shadow-2xl overflow-hidden relative">
              ...
              <div className="w-full h-full bg-gradient-to-b from-blue-50 to-green-50 relative">
                ...
                <div className="h-10 bg-emerald-600 flex items-end px-5 pb-1 relative z-10">
                ...
                <div className="absolute top-[40%] left-[30%] z-10">
                  <div className="bg-emerald-600 text-white text-[8px] font-bold px-2 py-1 rounded-full shadow-lg">Restaurante</div>
                </div>
                <div className="absolute top-[55%] left-[60%] z-10">
                  <div className="bg-emerald-700 text-white text-[8px] font-bold px-2 py-1 rounded-full shadow-lg">Hotel</div>
                </div>
                <div className="absolute top-[70%] left-[40%] z-10">
                  <div className="bg-emerald-500 text-white text-[8px] font-bold px-2 py-1 rounded-full shadow-lg">Lomas</div>
                </div>
              </div>
            </div>
          </motion.div>
