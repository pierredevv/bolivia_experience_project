...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-[90vh] flex items-end overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          height={1080}
        />
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-slate-800/60 to-emerald-900/30" />
        <motion.div
          className="absolute -top-1/4 -left-1/4 w-[800px] h-[800px] rounded-full bg-emerald-600/15 blur-[120px]"
          animate={{ x: [0, 40, 0], y: [0, 30, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute -bottom-1/4 -right-1/4 w-[600px] h-[600px] rounded-full bg-slate-800/20 blur-[100px]"
      ...
      <div className="hidden lg:block absolute right-[8%] top-1/2 -translate-y-1/2 z-10" aria-hidden="true">
        ...
        >
            ...
            <div className="w-full h-full bg-gradient-to-b from-slate-50 to-white overflow-hidden">
              ...
              <div className="bg-white px-4 py-3 border-b border-neutral-100">
                <div className="flex items-center gap-2">
                  <div className="h-6 w-6 bg-emerald-600 rounded-md flex items-center justify-center">
          ...
          <div className="absolute -inset-10 bg-emerald-500/10 rounded-full blur-3xl -z-10" />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20 pt-32">
        <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-slate-800/50">
          <div className="max-w-[600px]">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/15 text-white text-xs font-medium mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-2.5 px-6 py-3 text-base font-bold rounded-xl bg-emerald-600 text-white hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/20"
                >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-2.5 px-6 py-3 text-base font-semibold text-white border-2 border-white/20 hover:border-white/40 hover:bg-white/10 rounded-xl transition-all"
                >
                  {t('hero.cta2')}
                </motion.a>
              </div>
              ...
              <div className="flex gap-3">
                <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Google Play - Próximamente" className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/15 backdrop-blur-sm rounded-xl border border-white/15 transition-colors">
                  ...
                  <div>
                    <p className="text-[9px] text-white/50 leading-none">{t('hero.store.get')}</p>
                    <p className="text-xs text-white font-semibold">{t('hero.play')}</p>
                  </div>
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" aria-label="App Store - Próximamente" className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/15 backdrop-blur-sm rounded-xl border border-white/15 transition-colors">
