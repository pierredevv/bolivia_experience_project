...
/// y limita el radio (km o millas).
class RestaurantDistanceSheet extends ConsumerStatefulWidget {
  const RestaurantDistanceSheet({super.key});

  @override
  ConsumerState<RestaurantDistanceSheet> createState() =>
      _RestaurantDistanceSheetState();
}

class _RestaurantDistanceSheetState
    extends ConsumerState<RestaurantDistanceSheet> {
  final TextEditingController _searchController = TextEditingController();
  late double _radius;
  late bool _useMiles;
  RestaurantReference? _selected;
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  onPressed: () {
                    ref.read(restaurantsProvider.notifier).clearDistanceFilter();
              ...
              Expanded(
                ...
                child: ElevatedButton(
                  onPressed: _selected == null
                      ...
                      : () {
                          final notifier =
                              ref.read(restaurantsProvider.notifier);
                          notifier.setUseMiles(_useMiles);
                          notifier.setDistanceFilter(_selected, _radius);
                          Navigator.pop(context);
                        },
