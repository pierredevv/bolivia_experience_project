...
6. Pendiente (requiere acceso externo): integración de QR bancario real y verificación de cashback/premios con `exchangeRateSnapshot` cuando se soporte BOB.
